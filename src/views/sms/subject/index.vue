  ...
  <div class="app-container">
      ...
      <div class="filter-form">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          <el-form-item label="专题名称：">
            <el-input v-model="listQuery.subjectName" class="input-width" placeholder="专题名称" clearable></el-input>
          </el-form-item>
    ...
    <el-card class="list-container" shadow="hover">
      <div slot="header" class="clearfix card-header">
        <span class="card-title">
          <i class="el-icon-notebook-2"></i> <!-- Changed icon -->
          <span>专题推荐列表</span>
        </span>
        <div class="card-tools">
          ...
          <el-button 
            ...
            type="primary" 
            icon="el-icon-plus" 
            @click="handleSelectSubject()">
            选择专题
          </el-button>
        </div>
      </div>
      
      <!-- Changed ref name for clarity -->
      <el-table ref="subjectTable" 
        ...
        <el-table-column label="专题名称" min-width="200" align="center">
          <template slot-scope="scope">
        ...
        <template slot="empty">
          <div class="empty-data">
            <i class="el-icon-folder-opened"></i> <!-- Changed icon -->
            <p>暂无专题推荐数据</p>
          </div>
        </template>
      </el-table>
    ...
    <el-dialog 
      ...
      <el-table :data="dialogData.list"
                ...
                max-height="400">
        <el-table-column type="selection" width="60" align="center"></el-table-column>
        <el-table-column label="专题名称" min-width="180" align="center">
          <template slot-scope="scope">
            <span class="subject-name">{{scope.row.title}}</span>
          </template>
        </el-table-column>
        ...
        <el-table-column label="添加时间" width="180" align="center">
          <template slot-scope="scope">
            <el-tag size="medium" effect="plain" type="info">
              <i class="el-icon-time"></i> {{scope.row.createTime | formatTime}}
            </el-tag>
          </template>
        </el-table-column>
      </el-table>
...
<style scoped>
  ...
  .card-title i {
    margin-right: 8px;
    color: #909399; /* Changed icon color for subjects */
    font-size: 18px;
  }
