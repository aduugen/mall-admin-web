      ...
      <div class="filter-form">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          <el-form-item label="商品名称：">
            <el-input v-model="listQuery.productName" class="input-width" placeholder="商品名称" clearable></el-input>
          </el-form-item>
    ...
    <el-card class="list-container" shadow="hover">
      <div slot="header" class="clearfix card-header">
        <span class="card-title">
          <i class="el-icon-star-on"></i> <!-- Changed icon -->
          <span>人气推荐列表</span>
        </span>
      ...
      <el-table ref="hotProductTable" 
        ...
        <template slot="empty">
          <div class="empty-data">
            <i class="el-icon-star-off"></i> <!-- Changed icon -->
            <p>暂无人气推荐数据</p>
          </div>
        </template>
      </el-table>
...
<style scoped>
  ...
  .card-title i {
    margin-right: 8px;
    color: #E6A23C; /* Changed icon color to orange for hot products */
    font-size: 18px;
  }
